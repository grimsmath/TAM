...
class App extends CI_Controller
{
    ...
    public function index() {
        ...
        $data = [
            'header'   => $this->view->load('partials/header'),
            'masthead' => $this->view->load('partials/masthead'),
            'contents' => $this->view->load('view_dashboard')
        ];

        $this->view->load('templates/main', $data);
    }
